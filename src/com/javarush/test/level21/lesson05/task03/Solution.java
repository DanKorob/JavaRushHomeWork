...
public class Solution {
    ...
    {
        Date date = new Date();
        Solution sol1 = new Solution(35, "hello", 12.3, date, null);
        Solution sol2 = new Solution(35, "hello", 12.3, date, sol1);

        Thread.sleep(500);
        Date date1 = new Date();
        Solution sol3 = new Solution(35, "hello", 12.3, date, sol1);
