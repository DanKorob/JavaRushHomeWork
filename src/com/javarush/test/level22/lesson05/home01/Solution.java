...
3. Реализуйте логику трех protected методов в ThisUncaughtExceptionHandler используя вызовы
...
в) RuntimeException : java.lang.StringIndexOutOfBoundsException: String index
    out of range: -1 : 3#
*/
public class Solution {
    ...
    public String getPartOfString(String string, String threadName)
    {
        ...
        try
        {
            ...
            int indSecondTab = string.lastIndexOf("\t");

            result = string.substring(indFirstTab + 1, indSecondTab);
        }
        catch (Exception e)
        {
            switch (threadName)
